                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('Service Type *') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('service_type', old('service_type'), ['class' => 'form-control', 'placeholder' => trans('Service Type *')]) !!}
                              ...
                              <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('Standard Type *') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('standard_type', old('standard_type'), ['class' => 'form-control', 'placeholder' => trans('Standard Type *')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('Nace Type *') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('nace_type', old('nace_type'), ['class' => 'form-control', 'placeholder' => trans('Nace Type *')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('Other Nace *') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('other_nace', old('other_nace'), ['class' => 'form-control', 'placeholder' => trans('Other Nace *')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('Risk Category *') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('risk_cat', old('risk_cat'), ['class' => 'form-control', 'placeholder' => trans('Risk Category *')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('Proportion *') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('prportion', old('prportion'), ['class' => 'form-control', 'placeholder' => trans('Proportion *')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('Outsourcing *') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('outsourcing', old('outsourcing'), ['class' => 'form-control', 'placeholder' => trans('Outsourcing *')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('Management System *') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('management_sys', old('management_sys'), ['class' => 'form-control', 'placeholder' => trans('Management System *')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('Activity *') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('activity', old('activity'), ['class' => 'form-control', 'placeholder' => trans('Activity *')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('Audit Type *') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('audit_type', old('audit_type'), ['class' => 'form-control', 'placeholder' => trans('Audit Type *')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('Location No *') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('loc_no', old('loc_no'), ['class' => 'form-control', 'placeholder' => trans('Location No *')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('No of Shifts *') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('no_of_shifts', old('no_of_shifts'), ['class' => 'form-control', 'placeholder' => trans('No of Shifts *')]) !!}
