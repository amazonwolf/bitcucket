                            ...
                            <div class="col-sm-4">
                             ...
                             <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('contact_language') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="contact_language" id="country_id">
                            ...
                            <div class="col-sm-4">
                              ...
                              <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('contact_language_cert') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="contact_language_cert" id="country_id">
                                        <option value="">--- Select Language ---</option>
                                        <?php foreach ($languages as $value): ?>
                                            <option value="{{ $value->name }}">{{ $value->name }}</option>
                                        <?php endforeach; ?>
                        ...
                        <div class="row">
                             ...
                             <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('company_type') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="company_type" id="country_id">
                           ...
                           <!--  <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('Company Type *') ? ' has-error' : '' }}">
                                    {!! Form::label('company_type', trans('Company Type')) !!}
                                    {!! Form::text('company_type', old('company_type'), ['class' => 'form-control', 'placeholder' => trans('Company Type *')]) !!}
                                    {!! $errors->first('company_type', '<span class="help-block">:message</span>') !!}
                                </div>
                            </div> -->
