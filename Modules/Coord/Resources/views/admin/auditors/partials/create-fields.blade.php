                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('Auditor Name*') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => trans('Auditor Name')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('Auditor Address*') ? ' has-error' : '' }}">
                                    {!! Form::label('address', trans('Auditor Address')) !!}
                                    {!! Form::text('address', old('address'), ['class' => 'form-control', 'placeholder' => trans('Auditor Address')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('Auditor City*') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('city', old('city'), ['class' => 'form-control', 'placeholder' => trans('Auditor City*')]) !!}
                            ...
                            <div class="col-sm-4">
                                <div class="form-group{{ $errors->has('Auditor City*') ? ' has-error' : '' }}">
                                    ...
                                    {!! Form::text('timing', old('city'), ['class' => 'form-control', 'placeholder' => trans('Auditor Timing')]) !!}
